  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500 pb-10">
      <div className="mt-6 md:mt-2 mb-8 md:mb-14 flex justify-between items-center">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight">Your Groups</h2>
        <div className="flex gap-3">
           <button onClick={() => setJoinGroupOpen(true)} className="p-3 md:p-4 rounded-xl md:rounded-2xl glass text-emerald-400 hover:text-emerald-300 hover:bg-white/10 transition-colors">
             <Hash size={20} className="md:w-6 md:h-6" />
           </button>
           <button onClick={() => setCreateGroupOpen(true)} className="p-3 md:p-4 rounded-xl md:rounded-2xl glass text-blue-400 hover:text-blue-300 hover:bg-white/10 transition-colors">
      ...
      {isLoading ? (
        ...
        <div className="glass p-10 md:p-20 rounded-[32px] md:rounded-[48px] text-center border border-white/5 shadow-2xl mt-10 md:mt-16 max-w-2xl mx-auto">
           ...
           <h3 className="text-xl md:text-3xl font-bold mb-4 text-white">No groups yet</h3>
           <p className="text-sm md:text-xl text-gray-400 mb-8 md:mb-12">Create a group or join one to start scheduling time together.</p>
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex-1 pr-4">
                  ...
                  <p className="text-xs md:text-sm text-gray-400 mt-2.5 font-mono bg-black/40 inline-block px-3 py-1.5 md:px-4 md:py-2 rounded-lg tracking-[0.1em] border border-white/5">
                    CODE: <span className="text-white ml-1 font-bold">{group.invite_code.toUpperCase()}</span>
                  </p>
                </div>
